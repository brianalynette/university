...
// Raytracer code
////////////////////////////////////////////////////////////////////////////////
int calculate_distance(const Vector3d &origin, const Vector3d &point) {
...
bool is_light_visible(const Vector3d &ray_origin, const Vector3d &ray_direction, const Vector3d &light_position)
{
    ...
    int closest = find_nearest_object(ray_origin + (1e-6) * ray_direction.normalized(), light_position, p, N);

    int p_dist = calculate_distance(ray_origin,p);
    int light_dist = calculate_distance(ray_origin,light_position);

    if (closest >= 0 || p_dist > light_dist) {
